...
import org.example.Usuario.GerenciarUsuariosView;
...
public class CategoriaView extends JFrame{
    ...
    private JButton btnGerenciarUsuarios = new JButton("Gerenciar Usuários");
    ...
    public CategoriaView(boolean isAdmin) {
        ...
        if (isAdmin) {
            ...
            topo.add(btnEditar);
            topo.add(btnExcluir);
            topo.add(btnGerenciarUsuarios); // ← Aqui adicionamos o botão
        }
        ...
        if (isAdmin) {
            ...
            // Ação do botão de gerenciamento de usuários
